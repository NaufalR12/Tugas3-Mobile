...
class _MapScreenState extends State<MapScreen> {
  ...
  Future<void> _searchPlaces(String query) async {
    ...
    final url =
        'https://nominatim.openstreetmap.org/search?q=$query&format=json&limit=5&countrycodes=ID&accept-language=id';
                      ...
                      actions: [
                        TextButton.icon(
                          onPressed: () {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text("Koordinat disalin: $coords"),
                              ),
                            );
                          },
                          icon: Icon(Icons.copy),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Aplikasi LBS'),
        // The back button will be added automatically when this screen is pushed onto the navigation stack
      ),
      body: Stack(
        children: [
          FlutterMap(
            ...
            options: MapOptions(
              initialCenter: LatLng(
                -7.7769,
                110.3572,
              ), // Koordinat Babarsari, Sleman, Yogyakarta
              initialZoom: 13.0,
          ...
          // search widget
          Positioned(
            top: 10, // Reduced from 40 to account for the AppBar
            left: 15,
            right: 15,
            child: Column(
              children: [
